...
function lt_custom_posts() {
	lt_new_custom_post( 'banner', 'dashicons-groups', array('ubicacion') );
	$lt_meta_icon = array(
		'label'       => 'Icono',
		'description' => 'Icono de la categoría',
		'type'        => 'text',
	);
	$lt_meta_menu_icon = array(
		'label'       => 'Icono del Menú',
		'description' => 'Visible en el menu de la categoria',
		'type'        => 'text',
	);

	lt_add_meta_fields_to_taxonomy( $taxonomy_slug = 'category', $meta_fields = array(
		'lt_meta_icon'              => $lt_meta_icon,
		'lt_meta_menu_icon'         => $lt_meta_menu_icon,
	) );
}
