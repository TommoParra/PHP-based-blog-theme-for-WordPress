...
function captcha_display() {
  ...
  <div type="submit" onclick="send_comment_xD()" class="form-submit button button_sm button_black flex_row_center_between flex_no_wrap">SEND MESSAGE <span class="line line_sm line_white line_to_right"></span></div>
  CAPTCHA_FORM;
}
